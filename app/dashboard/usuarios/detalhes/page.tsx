...
function UsuarioDetalhesPageContent() {
  ...
  const availableDesignations = [
    { key: 'leitura_biblia', label: designationLabels['leitura_biblia'], show: isAdmin || targetRegister?.sexo === 'homem' },
    ...
    { key: 'dirigir_reuniao_de_campo', label: designationLabels['dirigir_reuniao_de_campo'], show: true },
    { key: 'audio_video', label: designationLabels['audio_video'], show: isAdmin || targetRegister?.sexo === 'homem' },
    { key: 'volante', label: designationLabels['volante'], show: isAdmin || targetRegister?.sexo === 'homem' },
    ...
    { key: 'estudo_biblico_congregacao', label: designationLabels['estudo_biblico_congregacao'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'nossa_vida_crista', label: designationLabels['nossa_vida_crista'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'presidente_meio_semana', label: designationLabels['presidente_meio_semana'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'presidente_fim_semana', label: designationLabels['presidente_fim_semana'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'leitor_sentinela', label: designationLabels['leitor_sentinela'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'dirigente_sentinela', label: designationLabels['dirigente_sentinela'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
  ]

  const availableResponsibilities = [
    { key: 'coordenador', label: responsibilityLabels['coordenador'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'secretario', label: responsibilityLabels['secretario'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'superintendente_servico', label: responsibilityLabels['superintendente_servico'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'superintendente_audio_video', label: responsibilityLabels['superintendente_audio_video'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'superintendente_vida_ministerio', label: responsibilityLabels['superintendente_vida_ministerio'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'superintendente_discursos_publicos', label: responsibilityLabels['superintendente_discursos_publicos'], show: isAdmin || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_contas', label: responsibilityLabels['servo_contas'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_publicacoes', label: responsibilityLabels['servo_publicacoes'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_carrinho', label: responsibilityLabels['servo_carrinho'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_territorio', label: responsibilityLabels['servo_territorio'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_limpeza', label: responsibilityLabels['servo_limpeza'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_quadro_anuncios', label: responsibilityLabels['servo_quadro_anuncios'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_audio_video', label: responsibilityLabels['servo_audio_video'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
    { key: 'servo_discursos', label: responsibilityLabels['servo_discursos'], show: isAdmin || targetRegister?.privilegioServico === 'servo_ministerial' || targetRegister?.privilegioServico === 'anciao' },
  ]
